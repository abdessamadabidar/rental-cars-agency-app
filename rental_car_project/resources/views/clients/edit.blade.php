    ...
    <div class="container">
        <div class="card testimonial-card shadow-0">
            <div class="card-body px-md-5">
                <form method="post" action="{{ route('clients.update', $client->id) }}" class="d-flex flex-column row-gap-4" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="row">
                        <div class="text-end">
                            <a href="{{ route('clients.index', $user->id) }}" role="button" class="btn annulerBtn shadow-0">Annuler</a>
